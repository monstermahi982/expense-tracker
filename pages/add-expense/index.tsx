...
export default function AddExpensePage() {
  ...
  const handleKeyDown = (e: KeyboardEvent<HTMLInputElement>, index: number) => {
    if (e.key === 'Enter') {
      ...
      if (currentExpense.amount) {
        ...
        // Focus the amount input of the new row after a short delay
        setTimeout(() => {
          const newAmountInput = document.getElementById(`amount-${expenses.length}`);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success(`${validExpenses.length} expenses added successfully`);
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="mx-auto max-w-2xl">
        <div className="mb-6 flex items-center space-x-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Quick Add Expenses</h1>
        </div>
          ...
          <Card className="neopop-card">
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Press Enter after entering an amount to add another expense. Title is optional.
              </p>
            </CardHeader>
            <CardContent>
